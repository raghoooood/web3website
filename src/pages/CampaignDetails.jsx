    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
          <div className="w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#2x2f32] cursor-poiner">
          ...
          <div>
            ...
            <p className=" font-epilogue font-normal text-[12px] text-[#808191]">10 Campaigns</p>
          </div>
        </div>
        </div>
        ...
        <p className="font-epilogue sont-normal 
      ...
      <h4 className="font-epilogue font-semibold text-[18px]
        ...
        <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
          ...
          <div className="mt-[30px]">
            ...
            border-[#3a3a43] bg-transparent font-epilogue 
            ...
            <div className="my-[20px] p-4 bg-[#13131a] rounded=[10px]">
              <h4 className="font-epilogue font-semibold text-[14px] leading-[22px] text-white">Back it beccause you belive in it</h4>
